...
/* Generated By:JJTree&JavaCC: Do not edit this line. MiniCV1.java */
...
public class MiniCV1/*@bgen(jjtree)*/implements MiniCTreeConstants, MiniCConstants {/*@bgen(jjtree)*/
  JJTMiniCState jjtree = new JJTMiniCState();
...
//    System.out.print("Enter an expression like \u005c"1+(2+3)*var;\u005c" :\n");
    MiniCV1 parser = new MiniCV1(System.in);
    try
    {
  ...
  final public SimpleNode Start() throws ParseException, ParseException {
 /*@bgen(jjtree) Start */
...
//����
 ...
 /*@bgen(jjtree) RelationChar */
  ...
  public MiniCV1(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public MiniCV1(java.io.InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public MiniCV1(java.io.Reader stream) {
  ...
  public MiniCV1(MiniCTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
